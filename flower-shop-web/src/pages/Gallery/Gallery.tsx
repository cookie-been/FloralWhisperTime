      ...
      <div className="border-b border-black/6 bg-[#f8f5ef]">
        <div className="mx-auto w-full max-w-[1680px] px-4 py-8 sm:px-6 sm:py-10 lg:px-10">
          <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr] xl:items-end">
            ...
            <div className="grid gap-4 rounded-lg border border-black/6 bg-white/72 p-4 backdrop-blur md:grid-cols-[minmax(0,1fr)_220px]">
              <Select
                className="md:hidden"
        ...
        {flowers.length > 0 ? (
          <>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              <p className="text-center text-sm text-muted">本页展示 {flowers.length} 件作品，可继续翻页浏览完整画廊。</p>
              <Pagination
