...
Page({
  data: {
    ...
    statCardList: [] as Array<{ value: string; label: string }>,
    siteConfig: {} as Partial<SiteConfig>,
    storyEyebrowText: "品牌故事",
    storyTitleText: "让花束像一封慢慢抵达的信",
    storyDescriptionText: "了解花语时光的品牌故事",
    featuredSectionTitleText: "热门花束",
    featuredSectionIntroText: "优先展示门店当前主推和高关注作品",
    storySectionTitleText: "品牌故事",
    storySectionIntroText: "了解花语时光的品牌故事",
  ...
  async loadPageData(isRefresh = false) {
    ...
    try {
      ...
      this.setData({
        ...
        statCardList: Array.isArray(siteConfig.stats) ? siteConfig.stats.slice(0, 4) : [],
        siteConfig,
        bannerList,
        ...
        featuredSectionTitleText: fallbackText(siteConfig.homeFeaturedSectionTitle, "热门花束"),
        featuredSectionIntroText: fallbackText(siteConfig.homeFeaturedSectionIntro, "优先展示门店当前主推和高关注作品"),
        storySectionTitleText: fallbackText(siteConfig.homeStorySectionTitle, "品牌故事"),
        storySectionIntroText: fallbackText(siteConfig.homeStorySectionIntro, "了解花语时光的品牌故事"),
